...
O bloco "Variável" o permite definir um dado valor a uma variável.
...
Significa que você pode aplicar operações em variáveis existentes.
...
Definirá sua variável com algum destes valores baseado no período do dia: `morning` (manhã), `afternoon` (tarde), `evening` (cedo da noite), `night` (tarde da noite).

Então você poderá usar essa variável para mostrar conteúdo condicionalmente:

<Frame style={{ maxWidth: '400px' }}>
  <img
    src="/images/blocks/logic/moment-condition.png"
    alt="Condição Momento do Dia"
  />
</Frame>
