...
<Frame>
  <img
    src="/images/admin/automation/blocks/integrations/webhook/variable-url.png"
    alt="Variavel em URL"
  />
</Frame>
...
<Frame style={{ maxWidth: '300px' }}>
  <img
    src="/images/admin/automation/blocks/integrations/webhook/variable-test-value.png"
...
<Frame style={{ maxWidth: '400px' }}>
  <img
    src="/images/admin/automation/blocks/integrations/webhook/save-in-variable.png"
    alt="Test request"
  />
</Frame>
...
<Frame>
  <img src="/images/admin/automation/blocks/integrations/webhook/preview.png" alt="Preview" />
</Frame>
...
<Frame>
  <img
    src="/images/admin/automation/blocks/integrations/webhook/simple-post.png"
...
A requisição do bloco de Webhook falhou ou não pareceu ser acionada? Certifique-se de verificar os [logs](/admin/automation/results/overview#logs). Se ainda não conseguir descobrir o que deu errado, me envie uma mensagem usando o botão de chat diretamente na ferramenta 👍
